        ...
        <div>
            ...
            <div className="login">
                ...
                <div className="social-media">
                    <button onClick={googleSignIn} className='google btn' onClick={googleSignIn}><FontAwesomeIcon icon={faGoogle}></FontAwesomeIcon> Sign In With Google</button>
                    <button onClick={fbSignIn} className='fb btn' onClick={fbSignIn}><FontAwesomeIcon icon={faFacebook}></FontAwesomeIcon> Sign in Using Facebook</button>
                </div>
            </div>
            {
                user.isSignedIn && <div>
            ...
            { user.success && <p style={{ color: 'green' }}>user {isNewUser ? 'Created' : 'Logged In'} successfully</p>}
        </div>
    );
};
